    ...
    <div class="form-container">
        <div class="card-form">
            <div class="form-title">
                <i class="bi bi-person-lines-fill me-2" style="color: #2563eb;"></i> Datos del Cliente
            </div>
            ...
            <form action="{{ route('clientes.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="correo" id="correo" class="form-control" value="{{ old('correo') }}" placeholder="ejemplo@cliente.com">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="telefono" id="telefono" class="form-control" value="{{ old('telefono') }}" placeholder="Ingresa el número de teléfono">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea name="direccion" id="direccion" rows="3" class="form-control" placeholder="Ingresa la dirección del cliente">{{ old('direccion') }}</textarea>
                </div>
