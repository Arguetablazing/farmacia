...
<div class="container py-4">
    <div class="header-form">
        <h1>
            <i class="bi bi-box"></i> Editar Producto
        </h1>
    ...
    <div class="form-container">
        <div class="card-form">
            ...
            <form action="{{ route('productos.update', $producto->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="proveedor" id="proveedor" class="form-control" value="{{ old('proveedor', $producto->proveedor) }}">
                        </div>
                    </div>
                ...
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="precio_compra" id="precio_compra" class="form-control" value="{{ old('precio_compra', $producto->precio_compra) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="precio_venta" id="precio_venta" class="form-control" value="{{ old('precio_venta', $producto->precio_venta) }}">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="estado" id="estado" class="form-select">
                                <option value="1" {{ old('estado', (string) $producto->estado) === '1' ? 'selected' : '' }}>Activo</option>
                                <option value="0" {{ old('estado', (string) $producto->estado) === '0' ? 'selected' : '' }}>Inactivo</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-title" style="margin-top: 10px;">
                    <i class="bi bi-image" style="color: #8b5cf6;"></i> Imagen del Producto
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="imagen" class="form-label">
                                <i class="bi bi-file-image"></i> Foto del Producto
                            </label>
                            <input type="file" name="imagen" id="imagen" class="form-control" accept="image/*" onchange="previewImage(event)">
                            <div class="mt-3">
                                @if($producto->imagen)
                                    <img id="preview" src="{{ asset($producto->imagen) }}" style="display: block; max-width: 200px; border-radius: 8px; border: 2px solid rgba(100, 180, 255, 0.3);">
                                @else
                                    <img id="preview" class="image-preview" style="display: none; max-width: 200px; border-radius: 8px; border: 2px solid rgba(100, 180, 255, 0.3);">
                                @endif
                            </div>
                        </div>
                    </div>
