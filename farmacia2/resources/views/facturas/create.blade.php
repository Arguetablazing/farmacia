                    ...
                    <div id="detalles-container">
                        ...
                        <div class="detalle-item" data-index="{{ $index }}">
                            <div class="form-group mb-0">
                                ...
                                <select id="detalle-producto-{{ $index }}" name="detalles[{{ $index }}][producto_id]" class="form-select" required>
                            ...
                            <div class="form-group mb-0">
                                ...
                                <input id="detalle-cantidad-{{ $index }}" type="number" name="detalles[{{ $index }}][cantidad]" min="1" class="form-control" required placeholder="Cantidad" value="{{ old("detalles.$index.cantidad") ?? $detalle['cantidad'] }}">
                            </div>
                            <div class="form-group mb-0">
                                <label class="form-label" for="detalle-precio-{{ $index }}">
                                    <i class="bi bi-currency-dollar"></i> Precio unitario
                                </label>
                                <input id="detalle-precio-{{ $index }}" type="number" step="0.01" name="detalles[{{ $index }}][precio_unitario]" min="0" class="form-control" required placeholder="Precio unitario" value="{{ old("detalles.$index.precio_unitario") ?? $detalle['precio_unitario'] }}">
                            </div>
