        ...
        <div class="card-form">
            ...
            <form action="{{ route('usuarios.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nombre" id="nombre" class="form-control" value="{{ old('nombre') }}" placeholder="Ingresa el nombre completo" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="correo" id="correo" class="form-control" value="{{ old('correo') }}" placeholder="ejemplo@farmacia.com" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="password" name="contraseña" id="contraseña" class="form-control" placeholder="Ingresa una contraseña segura" required>
                        <button type="button" class="btn-toggle-password" onclick="togglePassword('contraseña')">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="btn-toggle-password" onclick="togglePassword('contraseña_confirmation')">
                            <i class="bi bi-eye-fill"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-check">
                        <input type="checkbox" name="estado" id="estado" class="form-check-input" {{ old('estado', 1) ? 'checked' : '' }}>
